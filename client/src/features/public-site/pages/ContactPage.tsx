        ...
        <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[.72fr_1.28fr]">
          ...
          <form onSubmit={submit} className="rounded-[2rem] border border-slate-100 bg-white p-6 shadow-xl shadow-slate-200/50 md:p-9">
            <div className="grid gap-5 sm:grid-cols-2">
              ...
              <label className="grid gap-2 text-sm font-bold text-slate-700">Phone <span className="font-normal text-slate-400">(optional)</span><input value={form.phone} onChange={(e) => update("phone", e.target.value)} className="h-12 rounded-xl border border-slate-200 px-4 font-normal outline-none transition focus:border-primary focus:ring-4 focus:ring-violet-100" /></label>
